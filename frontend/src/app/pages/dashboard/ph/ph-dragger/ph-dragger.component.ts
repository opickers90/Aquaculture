...
@Component({
  selector: 'ngx-ph-dragger',
  templateUrl: './ph-dragger.component.html',
  styleUrls: ['./ph-dragger.component.scss'],
})
export class PhDraggerComponent implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = PhDraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
