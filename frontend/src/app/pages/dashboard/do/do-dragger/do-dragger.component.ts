...
@Component({
  selector: 'ngx-do-dragger',
  templateUrl: './do-dragger.component.html',
  styleUrls: ['./do-dragger.component.scss'],
})
export class DoDraggerComponent implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = DoDraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
