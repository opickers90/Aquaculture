...
@Component({
  selector: 'ngx-salinity-dragger',
  templateUrl: './salinity-dragged.component.html',
  styleUrls: ['./salinity-dragged.component.scss'],
})
export class SalinityDraggedComponent implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = SalinityDraggedComponent.toRad(this.bottomAngle);
    this.calculateVars();
